            ...
            NSFontAttributeName: UIFont(name: "Helvetica-Light", size: 16.0)!]],
                ...
                [[NSForegroundColorAttributeName: UIColor.whiteColor(),
                    ...
                    [NSForegroundColorAttributeName: UIColor.whiteColor(),
                        NSBackgroundColorAttributeName: UIColor.clearColor(),
                        NSFontAttributeName: UIFont(name: "Helvetica-Light", size: 16.0)!]]]
    private let photonames: [[String]] = [["Bald_Eagle_Web_Cam_View","Channel_Island_Live_Presentation"],["ANACAPA_LIGHTHOUSE","none"],["SCORPION_BAY","none"],["SMUGGLERS_COVE_1","SMUGGLERS_COVE_SAILBOATS"]]
    private var logonames: [String] = ["HIGHLIGHT_1_BIG", "HIGHLIGHT_2_BIG", "HIGHLIGHT_3_BIG","HIGHLIGHT_4_BIG"]
    private var HighlightTitlestrings: [String] = ["Channel Islands Live and\nChannel Islands National Park Visitor Center", " Anacapa Island", " Santa Cruz Island"," Santa Cruz Island"]
    ...
    */
    ...
    func enableHighlight1(hlightID : Int){
        if self.infoActive {
            ...
            */
            i = 0
            let skip : [[Bool]] = [[false,false],[false,true],[false,true],[false,false]]
