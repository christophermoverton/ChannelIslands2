...
class SantaCruzViewController: UIViewController, UITextViewDelegate, UITableViewDelegate,UIScrollViewDelegate {
    ...
    func loadScrollPageTV2(){
        ...
        self.actpageTableView2.frame = CGRectMake(200, 8275, 500, 3000)
        ...
        self.actpageTableView1.frame = CGRectMake(200, 8275, 500, 3000)
        ...
        self.actpageTableView22.frame = CGRectMake(200, 10950, 500, 2000)
        ...
        self.actpageTableView12.frame = CGRectMake(200, 10950, 500, 2000)
        ...
        campTV.frame = CGRectMake(200, 10900, 300, 50)
        campTV.alpha = 0
        campTV.backgroundColor = UIColor.clearColor()
        campTV2.frame = CGRectMake(200, 10900, 300, 50)
        campTV2.alpha = 0
